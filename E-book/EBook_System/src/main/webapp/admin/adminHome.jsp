...
<body style="background-color: #f0f1f2">
	...
	<div class="container p-5">
		<div class="row">
			<div class="col-md-3">
				<a href="add_books.jsp"><div class="card crd-ho text-center">
						<div class="card-body">
			...
			<div class="col-md-3">
				<a href="all_books.jsp"><div class="card crd-ho text-center">
						<div class="card-body">
				...
				<div class="col-md-3">
				<a href="all_order.jsp"><div class="card crd-ho text-center ">
						<div class="card-body">
			...
			<div class="col-md-3">
				...
				<div class="card crd-ho text-center">
						<div class="card-body">
					...
					<div class="modal-content">
						<div class="modal-header bg-primary">
							...
							<h5 class="modal-title text-center text-white"
								id="exampleModalLongTitle"><%=user1.getName()%></h5>
