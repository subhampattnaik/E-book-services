	...
	<div class="row">
		...
		<div class="col-md-4 mt-2">
			...
			<a class="btn btn-primary" href="login.jsp"><i
				class="fas fa-sign-in-alt"></i> Login</a> <a class="btn btn-success"
				href="create_account.jsp"><i class="fa fa-user-plus"
			...
			<a href="checkout.jsp"
				style="text-decoration: none; color: black; margin: 20px;"> <i
				class="fas fa-cart-plus fa-2x"></i>
			</a> 
		
			<a href="" class="btn btn-primary mr-2" style="margin-bottom: 10px" data-toggle="modal" 
				data-target="#exampleModal"><i class="fas fa-user-circle"></i> <%=user.getName()%></a>


				<button type="button" style="margin-bottom: 10px" data-toggle="modal" data-target="#lgBtn"
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="text-center p-3">
							<a href="logoutServlet" class="btn btn-danger">Logout</a> <a
...
<nav class="navbar navbar-expand-lg navbar-dark bg-color sticky-top ">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<a href="user_profile.jsp" class="btn btn-light"><i
			...
			class="btn btn-light ml-2"><i class="fas fa-phone-square-alt"></i>
			Contact Us</a>
