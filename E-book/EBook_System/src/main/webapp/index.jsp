	...
	<div class="container-fluid back-img">
		<div class="text-center">
			<h1 class="text-white p-4">
				<i class="fa fa-book" aria-hidden="true"></i> E-Book Services
			</h1>
		</div>
	</div>
	<!-- end banner -->
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="text-white">
							...
							%>
							<a href="view_books.jsp?bid=<%=b.getId() %>" class="btn btn-sm btn-success">View Details</a>
							<%
							}
							%>
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<p>
							...
							<%=b3.getCategories()%></p>
						<div class="text-white">
							<a href="view_books.jsp?bid=<%=b3.getId()%>" class="btn btn-success">View Details</a> <a
